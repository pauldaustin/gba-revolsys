...
public class LineSegmentUtil {
  public static void addElevation(final CoordinatesPrecisionModel precisionModel,
    final Coordinates lineStart, final Coordinates lineEnd, final Coordinates point) {
    final double z = getElevation(lineStart, lineEnd, point);
    point.setZ(z);
    precisionModel.makePrecise(point);
  }

  static double det(final double a, final double b, final double c, final double d) {
    return a * d - b * c;
  }
   ...
   * @return The distance.
   */
  public static double distance(final Coordinates lineStart, final Coordinates lineEnd,
  ...
  public static double distance(final Coordinates line1From, final Coordinates line1To,
    final Coordinates line2From, final Coordinates line2To) {
   ...
   */
  public static boolean envelopeIntersects(final Coordinates lineStart, final Coordinates lineEnd,
    final Coordinates point) {
    final double x1 = lineStart.getX();
    final double y1 = lineStart.getY();
  ...
  public static double getElevation(final Coordinates lineStart, final Coordinates lineEnd,
    final Coordinates point) {
   ...
   * @return
   */
  public static CoordinatesList getIntersection(final GeometryFactory geometryFactory,
    Coordinates line1Start, Coordinates line1End, Coordinates line2Start, Coordinates line2End) {
    ...
    if (BoundingBox.intersects(line1Start, line1End, line2Start, line2End)) {
      ...
      if (LineSegmentUtil.isPointOnLine(geometryFactory, line1Start, line1End, line2Start)) {
        final Coordinates intersection = getElevation(geometryFactory, line1Start, line1End,
          line2Start);
  ...
  public static boolean intersects(final Coordinates line1p1, final Coordinates line1p2,
    final Coordinates line2p1, final Coordinates line2p2) {
    final LineIntersector li = new RobustLineIntersector();
    li.computeIntersection(line1p1, line1p2, line2p1, line2p2);
    return li.hasIntersection();
  }

  public static boolean isPointOnLine(final Coordinates lineStart, final Coordinates lineEnd,
  ...
  public static boolean isPointOnLine(final CoordinatesPrecisionModel precisionModel,
    ...
    if (lineStart.equals2d(point)) {
      ...
      final double projectionFactor = projectionFactor(lineStart, lineEnd, point);
      if (projectionFactor >= 0.0 && projectionFactor <= 1.0) {
        final Coordinates projectedPoint = project(2, lineStart, lineEnd, projectionFactor);
  ...
  public static boolean isPointOnLineMiddle(final Coordinates lineStart, final Coordinates lineEnd,
    final Coordinates point, final double maxDistance) {
  ...
  public static boolean isPointOnLineMiddle(final CoordinatesPrecisionModel precisionModel,
    final Coordinates lineStart, final Coordinates lineEnd, final Coordinates point) {
    if (point.equals2d(lineStart)) {
      return false;
    } else if (point.equals2d(lineEnd)) {
  ...
  public static Coordinates midPoint(final Coordinates lineStart, final Coordinates lineEnd) {
    return midPoint(null, lineStart, lineEnd);
  }

  public static Coordinates midPoint(final CoordinatesPrecisionModel precisionModel,
    final Coordinates lineStart, final Coordinates lineEnd) {
    return project(precisionModel, lineStart, lineEnd, 0.5);
  }

  public static int orientationIndex(final Coordinates lineStart, final Coordinates lineEnd,
    final Coordinates point) {
   ...
   */
  public static double orientedAngleBetween2d(final Coordinates start, final Coordinates line1End,
  ...
  public static Coordinates pointAlong(final CoordinatesPrecisionModel precisionModel,
    final Coordinates lineStart, final Coordinates lineEnd, final Coordinates point) {
    final double projectionFactor = projectionFactor(lineStart, lineEnd, point);
  ...
  public static Coordinates project(final CoordinatesPrecisionModel precisionModel,
    final Coordinates lineStart, final Coordinates lineEnd, final Coordinates point) {
    if (point.equals2d(lineStart) || point.equals2d(lineEnd)) {
      ...
      final Coordinates projectedCoordinate = project(numAxis, lineStart, lineEnd, r);
  ...
  public static Coordinates project(final int numAxis, final Coordinates lineStart,
   ...
   */
  public static double projectionFactor(final Coordinates lineStart, final Coordinates lineEnd,
    final Coordinates point) {
    final double x1 = lineStart.getX();
    final double y1 = lineStart.getY();
  ...
  public static double segmentFraction(final Coordinates lineStart, final Coordinates lineEnd,
    final Coordinates point) {
  ...
  public static CoordinatesList toCoordinatesList(final int numAxis,
    ...
    final CoordinatesList points = new DoubleCoordinatesList(lineSegments.size() + 1, numAxis);
