...
public class DataObjectLayerFormTransferHandler extends TransferHandler {
  ...
  public DataObjectLayerFormTransferHandler(final RecordLayerForm form) {
  ...
  public boolean importData(final JComponent comp, final Transferable transferable) {
    for (final DataFlavor dataFlavor : Arrays.asList(DataObjectTransferable.DATA_OBJECT_FLAVOR,
