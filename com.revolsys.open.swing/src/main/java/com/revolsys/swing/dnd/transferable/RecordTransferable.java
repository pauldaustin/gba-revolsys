...
public class RecordTransferable implements Transferable {
  ...
  public static final DataFlavor DATA_OBJECT_FLAVOR = new DataFlavor(Record.class, "Record");
  ...
  public Object getTransferData(final DataFlavor flavor)
    ...
    if (this.object == null) {
      ...
      final Collection<String> attributeNames = this.object.getRecordDefinition().getFieldNames();
