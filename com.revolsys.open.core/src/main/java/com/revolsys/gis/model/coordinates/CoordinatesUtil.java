...
public class CoordinatesUtil {
  ...
  public static Coordinates add(final Coordinates coordinates, final double... deltas) {
  ...
  public static double angle(final Coordinates p1, final Coordinates p2, final Coordinates p3) {
   ...
   */
  public static double angleBetweenOriented(final Coordinates tip1, final Coordinates tail,
    final Coordinates tip2) {
  ...
  public static Coordinates circumcentre(final double x1, final double y1, final double x2,
  ...
  public static double distance(final Coordinates point1, final Coordinates point2) {
  ...
  public static double getElevation(final Coordinates coordinate, final Coordinates c0,
  ...
  public static boolean isAcute(final Coordinates point1, final Coordinates point2,
  ...
  public static Coordinates offset(final Coordinates coordinate, final double angle,
  ...
  public static float[] toFloatArray(final CoordinatesList points, final int numAxis) {
  ...
  public static Coordinates translate(final Coordinates point, final Double angle,
    final double length) {
