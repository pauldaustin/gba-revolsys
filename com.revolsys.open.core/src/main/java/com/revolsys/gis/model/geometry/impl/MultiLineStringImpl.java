...
public class MultiLineStringImpl extends GeometryCollectionImpl implements MultiLineString {

  public MultiLineStringImpl(final GeometryFactoryImpl geometryFactory,
    final Class<? extends LineString> geometryClass, final Collection<? extends Geometry> geometries) {
