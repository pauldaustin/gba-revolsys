...
public class LayerGroup extends AbstractLayer implements List<Layer>, Parent<Layer> {

  public static final MapObjectFactory FACTORY = new InvokeMethodMapObjectFactory("layerGroup",
