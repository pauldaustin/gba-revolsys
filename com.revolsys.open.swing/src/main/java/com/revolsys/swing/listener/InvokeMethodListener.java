...
public class InvokeMethodListener extends InvokeMethodPropertyChangeListener implements
ActionListener, DocumentListener, ListSelectionListener, ItemListener, PropertyChangeListener,
FocusListener, NonWeakListener {
