...
public class JdbcByteFieldDefinition extends JdbcFieldDefinition {
  public JdbcByteFieldDefinition(final String name, final int sqlType, final int length,
    final boolean required, final String description, final Map<String, Object> properties) {
    super(name, DataTypes.BYTE, sqlType, length, 0, required, description, properties);
  }

  @Override
  public JdbcByteFieldDefinition clone() {
    return new JdbcByteFieldDefinition(getName(), getSqlType(), getLength(), isRequired(),
