...
public class ListDataObjectReader extends AbstractReader<Record> implements RecordReader {
  ...
  public ListDataObjectReader(final RecordDefinition metaData, final Record... objects) {
