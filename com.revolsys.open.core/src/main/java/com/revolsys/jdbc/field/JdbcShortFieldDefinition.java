...
public class JdbcShortFieldDefinition extends JdbcFieldDefinition {
  public JdbcShortFieldDefinition(final String name, final int sqlType, final int length,
    final boolean required, final String description, final Map<String, Object> properties) {
    super(name, DataTypes.SHORT, sqlType, length, 0, required, description, properties);
  }

  @Override
  public JdbcShortFieldDefinition clone() {
    return new JdbcShortFieldDefinition(getName(), getSqlType(), getLength(), isRequired(),
