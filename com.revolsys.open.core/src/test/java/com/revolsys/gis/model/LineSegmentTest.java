...
public class LineSegmentTest {
  private static final GeometryFactory GEOMETRY_FACTORY_2D = GeometryFactory.getFactory(3005, 2,
    1000, 0);

  private static final GeometryFactory GEOMETRY_FACTORY_3D = GeometryFactory.getFactory(3005, 3,
    1000, 1000);
  ...
  public void assertIntersection3d(final Coordinates line1Start, final Coordinates line1End,
    ...
    final Coordinates... expectedIntersection) {
    final LineSegment line1 = new LineSegment(GEOMETRY_FACTORY_3D, line1Start, line1End);
    final LineSegment line2 = new LineSegment(GEOMETRY_FACTORY_3D, line2Start, line2End);
    final CoordinatesList points = new DoubleCoordinatesList(3, expectedIntersection);
  ...
  public void assertLinearIntersection(final double l1x1, final double l1y1, final double l1x2,
    ...
    final LineSegment line1 = new LineSegment(GEOMETRY_FACTORY_2D, l1x1, l1y1, l1x2, l1y2);
    final LineSegment line2 = new LineSegment(GEOMETRY_FACTORY_2D, l2x1, l2y1, l2x2, l2y2);
    final LineSegment line = new LineSegment(GEOMETRY_FACTORY_2D, lx1, ly1, lx2, ly2);
  ...
  public void linearIntersection() {
    ...
    assertIntersection3d(this.c_0_0_0, c(100, 0.001, 10), c(50, 0.001), c(70, 0.001),
      c(50, 0.001, 5), c(70, 0.001, 7));
  }
  ...
  public void pointIntersections() {
    ...
    assertIntersection3d(this.c_0_0_0, this.c_100_0_10, this.c_50_0, this.c_100_100_10,
      this.c_50_0_5);
    // Touch approximate
    assertIntersection3d(this.c_0_0_0, c(100, 0.001, 10), c(50, 0.001, 5), this.c_100_100_10,
      c(50, 0.001, 5));
