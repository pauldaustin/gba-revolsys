...
public class BaseTreeCellRendererOld extends DefaultTreeCellRenderer {
  private static final long serialVersionUID = 1L;

  private final String labelPropertyName;

  public BaseTreeCellRendererOld() {
    this(null);
  }

  public BaseTreeCellRendererOld(final String labelPropertyName) {
