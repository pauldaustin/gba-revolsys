...
public class SwitchRecordFields extends AbstractUndoableEdit {
  ...
  public SwitchRecordFields(final Record record, final String fieldName1, final Object value1,
  ...
  public SwitchRecordFields(final Record record, final String fieldName1, final String fieldName2) {
    this.record = record;
    this.fieldName1 = fieldName1;
    this.fieldName2 = fieldName2;
