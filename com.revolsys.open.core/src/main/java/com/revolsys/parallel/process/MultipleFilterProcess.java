...
public class MultipleFilterProcess<T> extends BaseInOutProcess<T, T> {
   ...
   * @return the filters
   */
  public Map<Predicate<T>, Channel<T>> getFilters() {
  ...
  protected boolean processFilter(final T object, final Predicate<T> filter,
   ...
   */
  public void setFilters(final Map<Predicate<T>, Channel<T>> filters) {
