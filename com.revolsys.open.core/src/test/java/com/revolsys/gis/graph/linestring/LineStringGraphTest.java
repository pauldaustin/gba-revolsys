...
public class LineStringGraphTest {
  GeometryFactory geometryFactory = GeometryFactory.getFactory(3005, 2, 1000.0, 1);
  ...
  public void testCleanupEndOfSegmentOverlap() {
    final LineString line = this.geometryFactory
      .createGeometry("LINESTRING(844000 1343000,844010 1343000,844020 1343000,844010 1343000)");
  ...
  public void testCleanupFigure8WithOverlap() {
    final LineString line = this.geometryFactory.createGeometry(
  ...
  public void testCleanupSplitCrossingEdgesMiddle() {
    final LineString line = this.geometryFactory
      .createGeometry("LINESTRING(844000 1343000,844100 1343100,844000 1343100,844100 1343000)");
    final LineStringGraph graph = new LineStringGraph(line);
  ...
  public void testCleanupSplitEdgesCloseToNodes() {
    final LineString line = this.geometryFactory.createGeometry(
      "LINESTRING(844000 1343000.001,844100 1343000,844100 1343010,844050 1343000.001)");
    final LineStringGraph graph = new LineStringGraph(line);
    graph.splitEdgesCloseToNodes();
    final List<LineString> lines = graph.getLines();
  ...
  public void testCleanupWholeSegmentOverlap() {
    final LineString line = this.geometryFactory
      .createGeometry("LINESTRING(844000 1343000,844100 1343000,844000 1343000)");
    final LineStringGraph graph = new LineStringGraph(line);
    final List<LineString> lines = graph.getLines();
    checkLines(lines, "LINESTRING(844000 1343000,844100 1343000)");
  }
  ...
  public void testIntersectionFalseEndEnd() {
    final LineString line1 = this.geometryFactory
      .createGeometry("LINESTRING(844000 1343000,844100 1343000,844200 1343000)");
    final LineStringGraph graph = new LineStringGraph(line1);
    final LineString line2 = this.geometryFactory
      .createGeometry("LINESTRING(844400 1343000,844300 1343000,844200 1343000)");
  ...
  public void testIntersectionFalseEndStart() {
    ...
    final LineStringGraph graph = new LineStringGraph(line1);
    final LineString line2 = this.geometryFactory
      .createGeometry("LINESTRING(844200 1343000,844300 1343000,844400 1343000)");
  ...
  public void testIntersectionFalseLoopEndLoop() {
    final LineString line1 = this.geometryFactory.createGeometry(
    ...
    final LineStringGraph graph = new LineStringGraph(line1);
    final LineString line2 = this.geometryFactory.createGeometry(
  ...
  public void testIntersectionFalseStartEndEndStart() {
    final LineString line1 = this.geometryFactory
      .createGeometry("LINESTRING(800000 1000000,800010 1000000,800010 1000010)");
    final LineStringGraph graph = new LineStringGraph(line1);
    final LineString line2 = this.geometryFactory
      .createGeometry("LINESTRING(800010 1000010,800000 1000010,800000 1000000)");
  ...
  public void testIntersectionFalseStartLoop() {
    ...
    final LineStringGraph graph = new LineStringGraph(line1);
    final LineString line2 = this.geometryFactory
      .createGeometry("LINESTRING(800000 1000010,800000 1000000)");
  ...
  public void testIntersectionFalseStartLoop1() {
    ...
    final LineStringGraph graph = new LineStringGraph(line1);
    final LineString line2 = this.geometryFactory.createGeometry(
      "LINESTRING(1189556.287 388686.558,1189555.995 388693.54,1189555.182 388694.284)");
  ...
  public void testIntersectionFalseStartStart() {
    ...
    final LineStringGraph graph = new LineStringGraph(line1);
    final LineString line2 = this.geometryFactory
      .createGeometry("LINESTRING(844000 1343000,843900 1343000,843800 1343000)");
  ...
  public void testIntersectionTrueEndMiddle() {
    final LineString line1 = this.geometryFactory
      .createGeometry("LINESTRING(800020 1000010,800010 1000010,800000 1000010)");
    final LineStringGraph graph = new LineStringGraph(line1);
    final LineString line2 = this.geometryFactory
      .createGeometry("LINESTRING(800000 1000000,800000 1000010,800000 1000020)");
  ...
  public void testIntersectionTrueMiddleMiddle() {
    final LineString line1 = this.geometryFactory
      .createGeometry("LINESTRING(800000 1000020,800010 1000010,800020 1000020)");
    final LineStringGraph graph = new LineStringGraph(line1);
    final LineString line2 = this.geometryFactory
      .createGeometry("LINESTRING(800000 1000000,800010 1000010,800020 1000000)");
  ...
  public void testIntersectionTrueMiddleStart() {
    ...
    final LineStringGraph graph = new LineStringGraph(line1);
    final LineString line2 = this.geometryFactory
      .createGeometry("LINESTRING(800000 1000010,800010 1000010,800020 1000010)");
